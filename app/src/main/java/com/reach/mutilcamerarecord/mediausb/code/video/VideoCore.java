...
import com.reach.mutilcamerarecord.mediausb.client.CallbackDelivery;
...
import com.reach.mutilcamerarecord.mediausb.model.MediaCodecGLWapper;
...
import com.reach.mutilcamerarecord.mediausb.model.OffScreenGLWapper;
import com.reach.mutilcamerarecord.mediausb.model.RecordConfig;
import com.reach.mutilcamerarecord.mediausb.model.ScreenGLWapper;
                ...
                case WHAT_RESET_VIDEO: {
                    ...
                    synchronized (syncVideoChangeListener) {
                        if (mVideoChangeListener != null) {
                            CallbackDelivery.i().post(new IVideoChange.VideoChangeRunable(mVideoChangeListener,
