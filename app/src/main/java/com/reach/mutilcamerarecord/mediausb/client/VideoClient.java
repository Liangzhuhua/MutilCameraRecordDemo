...
import com.reach.mutilcamerarecord.mediausb.code.CameraHelper;
import com.reach.mutilcamerarecord.mediausb.code.listener.IVideoChange;
import com.reach.mutilcamerarecord.mediausb.code.video.IVideoCore;
import com.reach.mutilcamerarecord.mediausb.code.video.VideoCore;
...
public class VideoClient {
        ...
        synchronized (syncOp) {
            try {
                if ((cameraNum - 1) >= config.getDefaultCamera()) {
                    ...
                    mIsFrontCamera = currentCameraIndex == Camera.CameraInfo.CAMERA_FACING_FRONT;
                }
    ...
    private Camera createCamera(int cameraId) {
        try {
            Log.e("createCamera", "------open usb camera:" + cameraId);//内置1
